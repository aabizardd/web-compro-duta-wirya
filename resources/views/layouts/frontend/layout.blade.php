...
<head>
    ...
    <!-- bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/bootstrap.min.css" type="text/css"
        media="all" />
    <!-- carousel CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/owl.carousel.min.css" type="text/css"
        media="all" />
    <!-- nivo-slider CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/nivo-slider.css" type="text/css"
        media="all" />
    <!-- animate CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/animate.css" type="text/css" media="all" />
    <!-- animated-text CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/animated-text.css" type="text/css"
        media="all" />
    <!-- font-awesome CSS -->
    ...
    <!-- theme-default CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/theme-default.css" type="text/css"
        media="all" />
    <!-- meanmenu CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/meanmenu.min.css" type="text/css"
        media="all" />
    <!-- Main Style CSS -->
    ...
    <!-- responsive CSS -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/fe/assets/css/responsive.css" type="text/css"
        media="all" />
    <!-- modernizr js -->
                    ...
                    <div class="header_top_menu_address">
                        <div class="header_top_menu_address_inner">
                            <ul>
                                ...
                                <li><a href="https://api.whatsapp.com/send?phone=62811875715" target="_blank"><i
                                            class="fa fa-whatsapp"></i>0811875715</a></li>
        ...
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="widget widgets-company-info">
                        <div class="footer-bottom-logo pb-40">
                            <img src="{{ asset('/') }}assets/admin/assets/img/logo dwpc bulat.png" alt=""
                                width="100" />
                        </div>
                        ...
                        <div class="menu-quick-link-container ml-4">
                            <ul id="menu-quick-link" class="menu">
                                @foreach ($jasa as $key => $item)
                                    @if ($key < 5)
                                        <li><a
                                                href="{{ url('jasa') . '?jasa=' . $item->id }}">{{ $item->nama_jasa }}</a>
                                        </li>
                                    @else
                                    @break
                                @endif
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="widget widgets-company-info">
                    ...
                    <div class="footer-social-info">
                        <p><i class="fa fa-whatsapp"></i> <span>Whatsapp :</span>
