                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('kantor-cabang.hapus', $item->id) }}" class="btn btn-danger btn-sm "><i class="fas fa-trash"></i> Hapus</a>
...
<script>
    $(document).ready(function () {
        ...
        $("#add_cabang").attr("action", "/kantor-cabang/update/" + dataId);
...
<script>
    $(document).ready(function () {
        $("#tambah_data_baru").click(function () {
            ...
            $("#add_cabang").attr("action", "/kantor-cabang/update/");
        });
    });
</script>
@endsection
