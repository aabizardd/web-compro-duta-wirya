            ...
            <div class="card-body">
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('/') }}assets/admin/assets/img/logo_client/{{ $item->logo_client }}"
                            ...
                            <td>
                                ...
                                <a href="" class="btn btn-warning btn-sm mb-2 ubah-data" id="ubah-data"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{ $item->id }}"><i
                                        class="fas fa-pencil"></i> Ubah</a>

                                <a href="{{ route('client.hapus', $item->id) }}" class="btn btn-danger btn-sm mb-2"><i
                ...
                <form action="{{ route('client') }}" method="POST" id="add_client" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pemberi_tugas" name="pemberi_tugas"
                            placeholder="Masukkan pemberi tugas ...." required>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.client) {
                    ...
                    $("#id_bidang_client").val(response.client[0].id_jasa);
